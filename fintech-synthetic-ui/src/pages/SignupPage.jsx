...
function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex bg-surface-950 font-sans">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 relative z-10">
        <div className="w-full max-w-md animate-slide-up">
          ...
          <div className="text-center lg:text-left mb-10">
            ...
            <p className="text-slate-400">Join Galarix and generate certified synthetic data.</p>
          </div>
      ...
      {/* Right Half - Branding & Visuals */}
      <div className="hidden lg:flex w-1/2 relative overflow-hidden bg-mesh flex-col justify-center items-center p-12 border-l border-white/5">
        <div className="relative z-10 text-center max-w-lg">
          <div className="w-20 h-20 mx-auto rounded-2xl bg-gradient-to-br from-brand-500 to-cyan-500 flex items-center justify-center shadow-lg shadow-brand-500/20 mb-8">
          ...
          <p className="text-lg text-slate-400">
            Join forward-thinking data teams generating mathematically robust financial datasets in seconds, without exposing a single real customer record.
          </p>
        </div>
